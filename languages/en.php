...
$plugin_tx['newsletter']['mail_subscribe_succes']="Thank you for signing up. You can cancel your subscription on our <a href=\"https://your_domain.com\">website</a>.";
...
$plugin_tx['newsletter']['terms_of_use']="<p><strong>Terms of use:</strong></p><p>Newsletter may only be used to send messages to subscribers who voluntary have agreed to receive messages from your website by subscribing. All other use is to be regarded as spamming and is prohibited. </p><p>Newsletter is released under Remove Link and Commercial License. Visit Newsletters page on <a href=\"http://simplesolutions.dk\">simpleSolutions</a> to buy license</p><p> By using the Newsletter you automatically accept these conditions.</p>";
