<?php
	...
	$plugin_tx['newsletter']['subscribe_fail']="Your subscription to the newsletter failed. Contact us via <a href=\"http://www.your domain.com/?mailform\"> website </a> or try again later.";
	$plugin_tx['newsletter']['unsubscribe']="Unsubscribe";
	$plugin_tx['newsletter']['unsubscribe_succes']="Your subscription is stopped.";
	$plugin_tx['newsletter']['unsubscribe_not_found']="not found. Subscription does not exist";
	...
	$plugin_tx['newsletter']['subscribe_confirmation_mail']="Thank you for signing up. Your subscription will be completed when you, within a few hours, will receive a confirmation email.";
	...
	$plugin_tx['newsletter']['mail_not_valid']="Your e-mail could not be confirmed. Please enter the correct email address..";
