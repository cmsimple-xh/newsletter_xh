...
$plugin_tx['newsletter']['subscribe_succes']="Thank you for signing up for the newsletter.";
$plugin_tx['newsletter']['subscribe_fail']="Your subscription to the newsletter failed. Contact us via <a href=\"http://www.your doamin.com/?mailform\"> website </ a> or try again later.";
$plugin_tx['newsletter']['unsubscribe']="Unsubscribe";
$plugin_tx['newsletter']['unsubscribe_succes']="Your subscription is stopped.";
$plugin_tx['newsletter']['unsubscribe_not_found']="is not found. Enter correct email and try again.";
$plugin_tx['newsletter']['unsubscribe_fail']="Could not remove your subscription. Contact us via <a href=\"http://www.your doamin.com/?mailform\"> website </ a> or try again later";
$plugin_tx['newsletter']['confirmation_mail']="You will receive a confirmation email within a few hours.";
$plugin_tx['newsletter']['confirmation_mail_error']="Confirmation e-mail was not sent because of an error: ";
$plugin_tx['newsletter']['mail_not_valid']="You have given wrong email address. <br> Enter the correct email address and try again.";
$plugin_tx['newsletter']['send']="Send";
$plugin_tx['newsletter']['subject']="Subject: ";
$plugin_tx['newsletter']['attachment']="Attach file";
$plugin_tx['newsletter']['newsletter_subject']="Newsletter from yourdomain.com";
...
//version 1.6
$plugin_tx['newsletter']['alt_unsubscribe']="You can unsubscribe from the newsletter here: "; //dynamic link to unsubscribe page is added her
